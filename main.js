...
(function () {
  ...
  const episodes = [
    {
      number: 287,
      title: 'The Cartesian Crisis',
      date: '2026-07-16',
      duration: '80 min',
      description: 'Matt and Michael ask why they\'ve stopped paying attention to the news. They land on a Cartesian crisis: nobody trusts anything, every claim meets an "actually," and skepticism can lead either to nihilism or wisdom.',
      url: 'https://soundcloud.com/shoresofignorance/ep-287-the-cartesian-crisis'
    },
    {
      number: 286,
